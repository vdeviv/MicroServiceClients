...
namespace Clients.Infrastructure.Repository
{
    public class ClientRepository : IRepository<Client> 
    {
        ...
        public async Task<Client> Create(Client entity)
        {
            ...
            const string query = @"
                INSERT INTO clients (first_name, last_name, nit, email, created_by, updated_by)
                VALUES (@first_name, @last_name, @nit, @email, @created_by, @updated_by);
            ";
        ...
        {
            string query = "UPDATE clients SET is_deleted = TRUE, updated_by = @updated_by WHERE id=@id";
